...
const s_widgetTitle = "Leave your comments";
...
// Apply CSS (disabled in favour of astro import)
...
// HTML Form
const v_mainHtml = /* HTML */ `
  <div id="c_inputDiv">
    <form
      id="c_form"
      onsubmit="c_submitButton.disabled = true; v_submitted = true;"
      method="post"
...
`;
const v_formHtml = /* HTML */ `
  <h2 id="c_widgetTitle">${s_widgetTitle}</h2>

  <div class="c-inputWrapper" id="c_nameWrapper">
    <label class="c-label c-nameLabel" for="entry.${s_nameId}"
      >${s_nameFieldLabel}</label
    >
    <input
  ...
  <div class="c-inputWrapper" id="c_websiteWrapper">
    <label class="c-label c-websiteLabel" for="entry.${s_websiteId}"
      >${s_websiteFieldLabel}</label
    >
    <input
  ...
  <div class="c-inputWrapper" id="c_textWrapper">
    <label class="c-label c-textLabel" for="entry.${s_textId}"
      >${s_textFieldLabel}</label
    >
    <textarea
